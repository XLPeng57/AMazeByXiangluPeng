...
//	 * @param percentToExit gives the distance to exit
	...
	private void drawBackground(MazePanel mazepanel) {
		...
		mazePanel.setColor(Color.rgb(182,228,251));
...
//		// dynamic color setting:
		mazePanel.setColor(Color.rgb(123,171,107));
...
//		System.out.print("sbsbsbsbsb");
//		Log.v("FirstPersonView: ","draw wall method");
//		System.out.print("sbsbsbsbsb");
		// some notes: 
		...
		//mazePanel.setColor(wall.getColor().toArgb());
		//mazepanel.setColor(wall.getColor().getRGB());

		//mazePanel.setColor(mazePanel.getWallColor(wall.getDistance(),rand,wall.getExtensionX()));
	...
	private boolean drawPolygons(MazePanel mazepanel, int x1, int x2, int y11, int y12, int y21, int y22) {
		...
		while (x1i <= x2) {
			...
			mazePanel.setColor(Color.rgb(86,159,176));
