...
public interface RobotDriver {
	 ...
	 */
	void setMaze(StatePlaying maze);
//
	...
	void Rotate(CardinalDirection cd) throws Exception;
	...
	boolean CheckLeftWall() throws Exception;
	boolean CheckFrontWall() throws Exception;
}
